...
# ZSI imports
from pysphere.ZSI import _get_element_nsuri_name
...
from pysphere.ZSI.twisted.interfaces import CheckInputArgs, HandlerChainInterface, CallbackChainInterface,\
    DataHandler
...
class WSResource(twisted.web.resource.Resource):
    """
    class variables:
        encoding  --
